                        ...
                        <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="balances d-flex align-items-center">
                                    <div>
                                        <h3 class="mb-0">REFERRAL BALANCE</h3>
                                        <h2 class="mb-0">$<?php echo $user_ref_bonus; ?></h2>
...
<?php 
							...
							<button type='submit'  name='cash_out' class='btn btn-sm btn-primary'>Withdraw</button> 
								<input type='hidden' name='coin' required value='BTC'  />
                                ...
                                <div class="card text-center">
                                    ...
                                    <div class="card-body p-t-10">
                                        <div class="input-group mb-3">
                                            <input type="text" id="copy-to-clipboard-input" class="form-control form-control-sm" value="https://racerstrade.com/signup.php?ref=<?php echo $user_name;?>" readonly >
