...
<link type="text/css" rel="stylesheet" charset="UTF-8" href="referals_files/translateelement.css"><script type="text/javascript" charset="UTF-8" src="referals_files/main.js"></script><script type="text/javascript" charset="UTF-8" src="referals_files/element_main.js"></script></head>
...
<div class="pace-activity"></div></div>
    ...
    <div id="goog-gt-tt" class="skiptranslate" dir="ltr"><div style="padding: 8px;"><div><div class="logo"><img src="referals_files/translate_24dp.png" alt="Google Translate" width="20" height="20"></div></div></div><div class="top" style="padding: 8px; float: left; width: 100%;"><h1 class="title gray">Original text</h1></div><div class="middle" style="padding: 8px;"><div class="original-text"></div></div><div class="bottom" style="padding: 8px;"><div class="activity-links"><span class="activity-link">Contribute a better translation</span><span class="activity-link"></span></div><div class="started-activity-container"><hr style="color: #CCC; background-color: #CCC; height: 1px; border: none;"><div class="activity-root"></div></div></div><div class="status-message" style="display: none;"></div></div><div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content mm-active" style="padding: 0px;">
            ...
            <!--end navigation-->
        </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 756px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 569px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
        <!--end sidebar wrapper -->
                 ...
                 <div class="container">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card text-center">
                            <div class="card-heading">
                                <h4 class="card-title text-muted mb-0">Referral  Link</h4>
                            </div>
                            <div class="card-body p-t-10">
                                <div class="input-group mb-3">
                                    <input type="text" id="copy-to-clipboard-input" class="form-control form-control-sm" value="ref/asa">
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="refcol text-center">
                                        <div class="refcolimg">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe text-primary"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
                                        </div>
                                        <span class="tit">Your Upline: </span>
                                        <span class="name">bestbtcsites_com</span>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="refcol">
                                        <div class="refcolimg">
                                            <div class="font-48 text-primary"> <i class="fadeIn animated bx bx-calculator"></i>
                                            </div>
                                        </div>
                                        <span class="tit">Referral comission:</span>
                                        <span class="name">$0.00</span>
                                        <div class="row">
                                            <div class="col-6">
                                                <h4>Total Referrals: <span>0</span> </h4>
                                            </div>
                                            <div class="col-6">
                                                <h4>Active Referrals: <span>0</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-6 col-md-12">
                        <form method="post" name="opts"><input type="hidden" name="form_id" value="16281798695828"><input type="hidden" name="form_token" value="0b45d3a98def1cae384a9adbf1063ad1">
                                        ...
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th scope="col">SIGNUPS</th>
                                                                                   ...
                                                                                   <tbody><tr>
                                                <td>No statistics found for this period.</td>
                                            </tr>
 ...
 <style>
    ...
    <script src="referals_files/clipboard.js"></script>
    <!--app JS-->
...
</div><div class="goog-te-spinner-pos"><div class="goog-te-spinner-animation"><svg xmlns="http://www.w3.org/2000/svg" class="goog-te-spinner" width="96px" height="96px" viewBox="0 0 66 66"><circle class="goog-te-spinner-path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"></circle></svg></div></div></body><grammarly-desktop-integration data-grammarly-shadow-root="true"></grammarly-desktop-integration></html>