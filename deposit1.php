...
<body class="  pace-done" style="position: relative; min-height: 100%; top: 0px;" data-new-gr-c-s-check-loaded="8.881.0" data-gr-ext-installed="">
    ...
    max-width: 100%;" class="default">
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/77a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/77d.svg" alt="#" style="display: block;max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Bitcoin Cash</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/71a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/71d.svg" alt="#" style="display: block;max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Dash</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/72a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/72d.svg" alt="#" style="display: block;max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Ripple</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/92a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/92d.svg" alt="#" style="display: block;max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Tether TRC20</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/85a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/85d.svg" alt="#" style="display: block;max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Tron</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/94a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/94d.svg" alt="#" style="display: block; max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            BNB</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/86a.svg" alt="#" style="display: block;   max-width: 100%;" class="active">
                                                        <img src="deposit_files/86d.svg" alt="#" style="display: block; max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Stellar</span>
                                            ...
                                            <label class="payrad filled">
                                                ...
                                                <span class="payrad-wrap">
                                                    <picture class="payrad-icon">
                                                        <img src="deposit_files/99a.svg" alt="#" style="display: block;max-width: 100%;" class="active">
                                                        <img src="deposit_files/99d.svg" alt="#" style="display: block;max-width: 100%;" class="default">
                                                    </picture>
                                                    <span class="payrad-text">
                                                        <span class="payrad-title">
                                                            Chiliz</span>
