...
<br/>
     <div class="row">
		...
		<h1 align="center">ADMIN ON CONFIRMED  TRANSACTION </h1>
<div style="font-size:17px;" >		
  ...
  <?php	
						...
						$cashout_tran = new run_query("select * from transaction where tran_status = 'PAID' and tran_desc ='CASH_OUT' ");
							$no_c = 1;
 ...
 <div class="col s12 m1 L1"> <br/><br/></div>
  ...
  <?php	
				...
				$queryt = new run_query("select * from transaction where tran_status='CONFIRMED'  and  tran_desc='DEPOSIT'  order by tran_id desc ");
				
	while(	$deposite_tran_data =	$queryt->result() ){
		extract($deposite_tran_data );	

												$querytas = new run_query("select * from users where user_email = '$tran_user_id' ");
