...
if (isset($_POST['update_info'])) {
    ...
    if ($password == $user_password) {
        $query211 = new run_query("Update users set fullname='$name',  address='$address',  btc_address='$btc_address' where user_email='$user_email'  ");
        echo "<script>alert(\"Profile Updated Successfully !!! \"); window.location.replace(\"edit_account.php\"); </script>";
    } else {
        echo "<script>alert(\"Invalid Password!!! \"); window.location.replace(\"edit_account.php\"); </script>";
    }
}
...
if (isset($_POST['password_btn'])) {
    ...
    $new_password1 = addslashes(htmlentities($_POST['confirm_password']));
    ...
    if ($old_password == $user_password) {
        if ($new_password == $new_password1) {
            ...
            echo "<script>alert(\"Password Changed Successfully !!! \"); window.location.replace(\"edit_account.php\"); </script>";
        } else {
            echo "<script>alert(\"Invalid Password Not Match!! \"); window.location.replace(\"edit_account.php\"); </script>";
        }
    } else {
        echo "<script>alert(\"Invalid Password!!! \"); window.location.replace(\"edit_account.php\"); </script>";
    }
                            ...
                            <div id="google_translate_element2">
                                <div class="skiptranslate goog-te-gadget" dir="ltr" style="">
                                    <div id=":0.targetLanguage"><select class="goog-te-combo" aria-label="Language Translate Widget">
                                        ...
                                        </select></div>Powered by <span style="white-space:nowrap"><a class="goog-logo-link" href="https://translate.google.com/" target="_blank"><img src="account_files/googlelogo_color_42x16dp.png" style="padding-right: 3px" alt="Google Translate" width="37px" height="14px">Translate</a></span>
                                </div>
                            </div>
...
<button class="btn btn-success" type="submit" name="password_btn">Update Login Details</button>
            ...
            <div id="goog-gt-tt" class="skiptranslate" dir="ltr">
                <div style="padding: 8px;">
                    <div>
                        <div class="logo"><img src="account_files/translate_24dp.png" alt="Google Translate" width="20" height="20"></div>
                    </div>
                </div>
